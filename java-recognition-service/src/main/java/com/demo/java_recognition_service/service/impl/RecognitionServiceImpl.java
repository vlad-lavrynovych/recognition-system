...
public class RecognitionServiceImpl implements RecognitionService {
    ...
    public RecognitionServiceImpl(
            ThresholdExecutor thresholdExecutor, KMeansExecutor kMeansExecutor) {
    ...
    @Override
    public JavaImagePerformanceResultDTO processThreshold(
            byte[] data,
            boolean erosion,
    ...
    @Override
    public JavaImagePerformanceResultDTO processKMeans(
            byte[] data,
            boolean erosion,
            boolean blurSelected) {
    ...
    @Override
    public byte[] processThresholdTest(
            byte[] data,
            boolean erosion,
            boolean blurSelected,
            int value) {
